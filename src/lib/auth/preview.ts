 ...
 * (broker: `app-builder-deployer/auth/src/preview-oauth.ts`). The secret is
 * read from the environment only  -  never committed  -  so the live preview
 * can do REAL sign-in  -  no demo/mock users  -  with no platform injection.
